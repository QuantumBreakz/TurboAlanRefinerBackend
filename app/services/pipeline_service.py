...
from app.models.domain import PassState, StageState, PassMetrics, PassTexts, RunResult, StrategyPlan
...
class RefinementPipeline:
    ...
    def run_pass(
        ...
        try:
            from app.core.language_model import analytics_store
        ...
        if dry_run:
            ...
            from app.core.logger import log_event as _log
        ...
        try:
            ...
            if edits_per_100 < min_edits or (1.0 - similarity) > max_similarity:
                ...
                try:
                    ...
                    from app.core.logger import log_event as _log3
